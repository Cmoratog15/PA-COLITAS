...
<?php }else{ ?>
        ...
        <div id="carouselIndicators" class="carousel slide cabecera" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active fondoc ">
                    <img src="img/hppp1.jpg" class="d-block w-80 img-fluid" alt="Donacion">
                    <div class="carousel-caption d-none d-md-block headerColitas">
                        <h2 class="serviciosHeader">Adopta a un <br>Perro Potencialmente Perfecto</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-5 mb-3 d-md-none headerColitas">
            <h2>Adopta a un Perro Potencialmente Perfecto</h2>
        </div>
        ...
        <div class="container-fluid mt-5 mb-4 punteroPerro" >
            <div class="row">
                <?php 
                    ...
                    $sentencia = $bd -> query('SELECT mascotas.nombre nombre, id_mascota, foto_del, genero, raza.nombre raza, fechaNacimiento, tamaño, peso, esterilizado, caracter, foto_tras, id_adoptante FROM mascotas JOIN raza ON mascotas.id_raza = raza.id_raza WHERE raza.id_tipo = 3');
                ...
                <div class="col-xxl-6">
                    <div class="card tarjeta" id="<?php echo $dato->id_mascota?>">
                        ...
                        <div  class="face front">
                            ...
                            <div class="row card-body">
                                <div class="col-sm-3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <img src="<?php echo $dato->foto_del?>" class="img-fluid fotoDNI" alt="fotoPPP" width="110">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            method="post"> <!--Abro form para pasar el dato [nombre] a la otra página -->
                                                <input type="hidden" name="nombrePerroPPP" value="<?php echo $dato->nombre?>"> <!--Dato que recojo, lo oculto para que no se vea aquí -->
                        ...
                        <div class="face back">
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="<?php echo $dato->foto_tras?>" class="img-fluid" alt="fotoPPPtras">
                                </div>
                            </div>
                        </div>
                    </div>
